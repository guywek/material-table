...
var MTablePaginationInner = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(MTablePaginationInner, [{
    ...
    value: function render() {
      ...
      }, localization.labelDisplayedRows.replace('{from}', this.props.page * this.props.rowsPerPage + 1).replace('{to}', Math.min((this.props.page + 1) * this.props.rowsPerPage, this.props.count)).replace('{count}', this.props.count)), /*#__PURE__*/React.createElement(_Tooltip["default"], {
